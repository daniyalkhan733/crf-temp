...
------------------------------------------------
    ...
    @version         : 1.0.0
    @Template Name   : Care and Relief Foundation
...
(function ($) {
 ...
 /*----------------------------------------------
  ...
  $("#play-video-two").on("click", function (e) {
    e.preventDefault();
    $("#video-overlay").addClass("open");
    $("#video-overlay").append('<iframe width="800" height="600" src="https://www.youtube.com/embed/aZctAYvPMj8" title="Rubina BB Monthly Food Pack JULY-2019" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>');
  });
